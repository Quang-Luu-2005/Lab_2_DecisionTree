...
Decision Tree là mô hình nghiên cứu chính. Random Forest, SVM--RBF và KNN chỉ là reference baselines đại diện cho ensemble tree, kernel và instance-based learning \cite{breiman2001rf,cortes1995svm,cover1967knn}. Bảng~\ref{tab:best-models} tóm tắt mô hình tốt nhất trên từng dataset.
