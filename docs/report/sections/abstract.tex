...
Trong bài này, nhóm chúng em chọn Covertype làm case study chính để xây dựng, phân tích và cải tiến Decision Tree. Nhóm dùng Letter Recognition và Handwritten Digits để kiểm tra độ bền của kết luận; Random Forest, Support Vector Machine và K-Nearest Neighbors được dùng làm các mô hình đối chứng mở rộng. Mọi thí nghiệm dùng phép chia 80/20 phân tầng với \texttt{random\_state=42}; việc chọn tham số chỉ truy cập tập train. Bên cạnh accuracy và macro-F1, nhóm báo cáo error rate, recall theo lớp, train--test gap, thời gian thực thi, depth và number of leaves.
