...
\begin{frame}
  ...
  \begin{tabularx}{\textwidth}{@{}L{2.8cm}C{1.55cm}C{1.35cm}C{1.0cm}Y@{}}
    \toprule
...
\begin{frame}
  ...
  \chaptertag{5}{THỰC NGHIỆM VÀ PHÂN TÍCH KẾT QUẢ}
  \begin{center}
    \includegraphics[width=0.92\linewidth,height=0.40\textheight,keepaspectratio]{dt_covertype_baseline__tree_top_levels.png}
  \end{center}
  \vspace{-0.12cm}
  \begin{center}
  ...
  \end{center}
  \vspace{0.12cm}
  {\small\textbf{Một luật top-level:} nếu \texttt{Elevation $\leq$ 3044,5}, mẫu đi sang nhánh mà lớp 2 chiếm ưu thế. Cây đầy đủ sâu \textbf{41 tầng} với \textbf{23.956 lá}.}
