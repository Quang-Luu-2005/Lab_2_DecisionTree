"""Generate notebooks/decision_tree/06_gini_vs_entropy_experiment.ipynb cleanly."""
...
NOTEBOOK_PATH = (
    PROJECT_ROOT / "notebooks" / "decision_tree" / "06_gini_vs_entropy_experiment.ipynb"
)
...
cells = [
    ...
    },
    {
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## 2. Huấn luyện mô hình và so sánh Gini vs Entropy\n"],
    },
    {
        "cell_type": "code",
        "execution_count": None,
    ...
    },
    {
        "cell_type": "markdown",
        "metadata": {},
        "source": ["## 3. Hiển thị kết quả tổng hợp\n"],
    },
    {
        "cell_type": "code",
        "execution_count": None,
